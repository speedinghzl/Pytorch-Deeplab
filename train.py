...
BATCH_SIZE = 10
DATA_DIRECTORY = '/workspace/hzl/data/VOCdevkit/voc12'
...
def main():
    ...
    trainloader = data.DataLoader(VOCDataSet(args.data_dir, args.data_list, crop_size=input_size, mean=IMG_MEAN), 
    ...
    while i_iter < args.num_steps:
        for iteration, batch in enumerate(trainloader):
            ...
            print s2-s1,'seconds/forward'
            print s3-s2,'seconds/loss'
            print s4-s3,'seconds/backward'
            print s5-s4,'seconds/update'
